...
const float Control_Unit[18][20]=
{
  ...
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 100,  4.00   ,0.00  ,0.00  ,0  ,0 , 500,   1 ,  1 ,  1 },//Pitch_Angle;偏航角度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 300,  0.75   ,1.50  ,1.80  ,0  ,0 , 1000,  1 ,  1 ,  1 },//Pitch_Gyro;偏航角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 100,  4.00   ,0.00  ,0.00  ,0  ,0 , 500,   1 ,  1 ,  1 },//Roll_Angle;横滚角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 300,  0.75   ,1.50  ,1.80  ,0  ,0 , 1000,  1 ,  1 ,  1 },//Roll_Gyro;横滚角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,45  ,0  ,0 , 150 , 4.00   ,0.00  ,0.00  ,0  ,0 , 500,   1 ,  1 ,  1 },//Yaw_Angle;偏航角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,300 ,0  ,0 , 200,  1.20   ,1.00  ,0.00  ,0  ,0 , 800,   1 ,  1 ,  1 },//Yaw_Gyro;偏航角速度 
#endif
  ...
  */
  ...
  /*************加速度控制器****************/
  //期望最大加速度1000cm/s^2
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,1500 ,0  ,0 ,750,0.12    ,1.5000    ,0.0  ,0   ,0 ,1000,  1 ,  1 ,  1 },//垂直加速度控制器		
  ...
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,100   ,30  ,0 ,200, 4.50  ,0.05   ,0.0  ,0   ,0 ,450 , 1 ,  1 ,  1 },//光流水平速度控制器
		
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,50    ,30  ,0 ,100, 0.45  ,0.00   ,1.0 ,0   ,0 ,300  , 1 ,  1 ,  1 },//SDK位置控制器   2.5  150
};
...
void Total_PID_Init(void)
{
  ...
  Set_Cutoff_Frequency(WP_Duty_Freq, 30,&Control_Device_Div_LPF_Parameter_For_Gyro);//15  10
}
