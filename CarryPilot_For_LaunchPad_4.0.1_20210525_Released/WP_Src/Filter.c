...
{
	//加速度计高阶低通滤波参数
	Accel_Z_Butter_Filter=filterIIRButterLowpass(20,0,30,0,1,20,200,FILTER_IIR_BUTTER_LOW);//最大1dB衰减通带，阻带至少20DB衰减
...
////////////////////////////////////////////	
		...
		//加速度计高阶低通滤波参数
	Accel_X_INS=filterIIRButterLowpass(30,0,90,0,1,80,200,FILTER_IIR_BUTTER_LOW);//最大1dB衰减通带，阻带至少40DB衰减
...
///////////////////////////////////////////////	
	//陀螺仪高阶低通滤波参数
	Gyro_X_Butter_Filter=filterIIRButterLowpass(50,0,70,0,0.5,20,200,FILTER_IIR_BUTTER_LOW);//最大1dB衰减通带，阻带至少20DB衰减
