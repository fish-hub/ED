...
void draw_ins_wave(void)
{
	...
	for(uint16_t i=127;i>0;i--)
	{
		...
		Draw_Wave_Buf[0][0]=NamelessQuad.Speed[_YAW];
		Draw_Wave_Buf[1][0]=NamelessQuad.Acceleration[_YAW];	
	...
	for(uint16_t i=0;i<128;i++)
	{
	  ...
	  ssd1306_draw_pixel(i, temp1, WHITE);
		ssd1306_draw_pixel(i, temp2, WHITE);
	}	
	ssd1306_display();
}
...
//	
//	x1=63+32*constrain_float(NamelessQuad.Position[_PITCH]/Map_Scale,-1.0f,1.0f);
//	y1=31+32*constrain_float(NamelessQuad.Position[_ROLL]/Map_Scale,-1.0f,1.0f);

//	x2=63+32*constrain_float(Earth_Frame_To_XYZ.E/Map_Scale,-1.0f,1.0f);
//	y2=31+32*constrain_float(Earth_Frame_To_XYZ.N/Map_Scale,-1.0f,1.0f);	
//	
//	ssd1306_fill_circle(x1,y1,3,WHITE);
//	ssd1306_draw_circle(x2,y2,5,WHITE);
//	
//	ssd1306_display();
}
